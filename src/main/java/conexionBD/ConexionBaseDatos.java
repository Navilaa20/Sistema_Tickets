...
public class ConexionBaseDatos {
    ...
    public static Connection BaseDatos () {
        ...
        try{
            connection = DriverManager.getConnection("jdbc:postgresql://yamanote.proxy.rlwy.net:12931/railway", "postgres", "GYRHOEPpfIPlRhTvErxhvLRqtpwNcTFN");

            //postgresql://postgres:GYRHOEPpfIPlRhTvErxhvLRqtpwNcTFN@yamanote.proxy.rlwy.net:12931/railway
